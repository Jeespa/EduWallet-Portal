...
const UIO_ORG_NUMBER = "971035854";
...
type RegisteringOrganization = "ntnu" | "tbs" | "uio";
...
async function main() {
  ...
  const uioSmartAccountAddress = await studentsRegister
    .connect(uioWallet)
    .getUniversityAccount();
  ...
  const demoOutput = {
    organizations: {
      ...
      uio: {
        ...
        address: uioWallet.address,
        smartAccountAddress: uioSmartAccountAddress,
      },
    },
