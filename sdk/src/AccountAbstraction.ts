...
import { SmartAccount__factory } from "@typechain/factories/contracts/SmartAccount__factory";
import { blockchainConfig, logError } from "src/conf";
import { EntryPoint } from "@typechain/@account-abstraction/contracts/core/EntryPoint";
...
export class AccountAbstraction {
   ...
   * @param params User operation parameters (sender, target, value, data, initCode)
